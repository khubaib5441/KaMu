...
public class DeleteItems {
    ...
    public DeleteItems() {
        ...
        drugNames.setEditable(false);
        drugNames.setPromptText("Drug Name");
    ...
    private void deleteItems(){
        ...
        new ComboBoxAutoComplete<String>(drugNames);
        ...
        drugNames.setOnHiding(keyevent->{
            try {
        ...
        deleteEveryButton.setOnAction(e->{
            try {
                String sql="delete * from AddDrugs";
                preparedStatement=connection.prepareStatement(sql);
                preparedStatement.execute();
                JOptionPane.showMessageDialog(null,"Delete EveryThing");
